...
namespace heading {
    ...
    export function scan(ms: number): number {
        ...
        if (testing) {
            // simulateScan("Zdn70") // X-Axis vertical; spun around X-Axis; 70-degreee dip
            // simulateScan("Yup70") // Y-Axis vertical; spun around Y-Axis; 70-degreee dip
            simulateScan("distort")
            // simulateScan("tetra")
            basic.pause(ms)
        } else {
